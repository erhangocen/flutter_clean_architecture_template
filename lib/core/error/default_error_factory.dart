import 'package:student_app/core/error/error_models/api_error_model.dart';
...
class DefaultErrorFactory extends ErrorFactory {
  @override
  DefaultError createApiError(error, StackTrace stackTrace, ApiErrorModel errorModel) =>
